...
export const $sidebarProjectOrderIds = atom(storedStringArray(SIDEBAR_PROJECT_ORDER_STORAGE_KEY))
...
$sidebarProjectOrderIds.subscribe(ids => persistStringArray(SIDEBAR_PROJECT_ORDER_STORAGE_KEY, [...ids]))
